...
Procédure jury : [DEMO_EPREUVE.md](../1.2 Préparer le déploiement d'une application/1.2.8 Procédure d'exécution des tests (épreuve).md) · Fiches **ST-F** : [1.2.2 Elaborer un scénario de test](../1.2 Préparer le déploiement d'une application/1.2.2 Elaborer un scénario de test.md)
