...
> **Outils & stratégies détaillés :** [OUTILS_STRATEGIES_TESTS_SECURITE.md](../1.2 Préparer le déploiement d'une application/1.2.4 Les outils et les stratégies des tests de sécurité.md).
...
| **Trace** | `src/utils/security.test.ts`, [OUTILS_STRATEGIES_TESTS_SECURITE.md](../1.2 Préparer le déploiement d'une application/1.2.4 Les outils et les stratégies des tests de sécurité.md) |
...
| **Trace** | `ci.yml` (job audit), `security-scan.yml`, [SECURITE_AUDIT.md](./1.2 Préparer le déploiement d'une application/1.2.4.3 Audit des dépendances.md) |
...
**Validation :** [VALIDER_RESULTATS_TESTS.md](../1.2 Préparer le déploiement d'une application/1.2.6 Valider les résultats des tests.md)
