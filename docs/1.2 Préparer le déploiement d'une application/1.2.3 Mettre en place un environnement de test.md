...
Complète [1.1.3 Les bases d'un environnement de test](../1.1 Les bases de la démarche DevOps/1.1.3 Les bases d'un environnement de test.md) avec un **environnement intermédiaire** entre la CI et la production.
