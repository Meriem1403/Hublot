...
|----------|----------|-----|
| Local | `npm audit` | — |
| Pipeline | `npm run audit:prod` | **Bloquant** en CI (critical + high hors allowlist) — voir [SECURITE_AUDIT.md](./1.2 Préparer le déploiement d'une application/1.2.4.3 Audit des dépendances.md) |
