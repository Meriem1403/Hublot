...
- [ENJEUX_PLAN_TEST.md](../1.2 Préparer le déploiement d'une application/1.2.1 Les enjeux des plans de test.md) — *pourquoi* planifier (enjeux, risques)
- [PLAN_TEST.md](../1.3 Rédiger des scriptes dans la démarche DevOps/1.3.7 Automatiser les tests en DevOps.md) — *quoi* tester (tableau Objectif / Résultat / Statut)
- [SCENARIOS_TEST.md](../1.2 Préparer le déploiement d'une application/1.2.2 Elaborer un scénario de test.md) — *comment* décrire chaque cas (ST-F*, ST-SEC*)
- [ENVIRONNEMENT_TEST.md](../1.1 Les bases de la démarche DevOps/1.1.3 Les bases d'un environnement de test.md) — *où* exécuter (DEV, CI, STAGING, PROD)
- [OUTILS_STRATEGIES_TESTS_SECURITE.md](../1.2 Préparer le déploiement d'une application/1.2.4 Les outils et les stratégies des tests de sécurité.md) — tests de sécurité
...
| **2. Priorités** | Critique / Haute / Moyenne / Basse ? | Colonne priorité dans [SCENARIOS_TEST.md](../1.2 Préparer le déploiement d'une application/1.2.2 Elaborer un scénario de test.md) |
...
| **5. Environnement** | DEV, CI, STAGING ou PROD ? | [ENVIRONNEMENT_TEST.md](../1.1 Les bases de la démarche DevOps/1.1.3 Les bases d'un environnement de test.md) |
| **6. Traçabilité** | Passé / Échec / À exécuter ? | [PLAN_TEST.md](../1.3 Rédiger des scriptes dans la démarche DevOps/1.3.7 Automatiser les tests en DevOps.md) + runs GitHub Actions |
...
|--------|--------|----------|----------------------|
| **Données RH fausses** (filtres, calculs ETP, parité) | Décisions de gestion erronées | **Critique** | 48 tests unitaires métier/sécurité + ST-F02, ST-F03 |
...
- [ ] **Statuts à jour** dans [PLAN_TEST.md](../1.3 Rédiger des scriptes dans la démarche DevOps/1.3.7 Automatiser les tests en DevOps.md)
...
Rapport d'exécution : [RAPPORT_EXECUTION_TESTS.md](./1.2 Préparer le déploiement d'une application/1.2.9 Rapport d'exécution des tests.md).
